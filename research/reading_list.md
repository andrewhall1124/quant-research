...
| Heston, Jones, Khorram, Li and Mo (2023) | Option Momentum | JF | Past delta-hedged straddle returns predict future ones (momentum at 1–12 months, reversal at 1 month). A pure time-series alpha on the reference returns already stored. |
