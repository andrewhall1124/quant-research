...
its own caches live under `research/backtest/results/`.
...
from research.backtest.config import BacktestConfig, BacktestResult, Leg
from research.backtest.engine import BacktestContext, build_context, build_returns, run
